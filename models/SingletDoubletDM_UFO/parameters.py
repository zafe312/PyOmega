...
LS4 = 	 Parameter(name='LS4', 
	 nature = 'internal', 
	 type = 'complex', 
	 value = 'rLS4 + complex(0,1)*iLS4', 
	 texname = '\\text{LS4}' ) 
 
LS12 = 	 Parameter(name='LS12', 
	 nature = 'internal', 
	 type = 'complex', 
	 value = 'rLS12 + complex(0,1)*iLS12', 
	 texname = '\\text{LS12}' ) 
 
LS21 = 	 Parameter(name='LS21', 
	 nature = 'internal', 
	 type = 'complex', 
	 value = 'rLS21 + complex(0,1)*iLS21', 
	 texname = '\\text{LS21}' ) 
 
L5 = 	 Parameter(name='L5', 
	 nature = 'internal', 
	 type = 'complex', 
	 value = 'rL5 + complex(0,1)*iL5', 
	 texname = '\\text{L5}' ) 
 
LS4c = 	 Parameter(name='LS4c', 
	 nature = 'internal', 
	 type = 'complex', 
	 value = 'rLS4c + complex(0,1)*iLS4c', 
	 texname = '\\text{LS4c}' ) 
 
LS1 = 	 Parameter(name='LS1', 
	 nature = 'internal', 
	 type = 'complex', 
	 value = 'rLS1 + complex(0,1)*iLS1', 
	 texname = '\\text{LS1}' ) 
 
LS2 = 	 Parameter(name='LS2', 
	 nature = 'internal', 
	 type = 'complex', 
	 value = 'rLS2 + complex(0,1)*iLS2', 
	 texname = '\\text{LS2}' ) 
